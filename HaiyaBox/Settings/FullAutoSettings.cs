...
public class AutomationSettings
{
    ...
    public void UpdateRoleSelection(Dictionary<string, bool> selection)
    {
        ...
        foreach (var pair in selection) RoleSelection[pair.Key] = pair.Value;
        FullAutoSettings.Instance.Save();
    }
    ...
    public void UpdateRollSelection(Dictionary<string, bool> selection)
    {
        ...
        foreach (var pair in selection) RollSelection[pair.Key] = pair.Value;
        FullAutoSettings.Instance.Save();
    }
    ...
    private static Dictionary<string, bool> CreateDefaultRoleSelection()
    {
    ...
    private static Dictionary<string, bool> CreateDefaultRollSelection()
    {
        return new Dictionary<string, bool>
        {
            { "MT", true },
